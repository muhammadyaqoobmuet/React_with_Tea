...
export const FullMenu = () => {
    const menu = [
        ...
        },
        {
          ...
          category: "dinner",
          price: 22.99,
          img: "./public/images/item-10.jpeg",
          desc: `skateboard fam synth authentic semiotics. Live-edge lyft af, edison bulb yuccie crucifix microdosing.`,
        },
      ];
...
const [catogries,setCatogries] = useState(allCatogries);
...
function filterItems(category){
  ...
  return (
        <main>
            ...
            <h1 className='text-3xl text-center mt-10'>MENU</h1>
                <Catogories catogries={catogries} filterItems ={filterItems} />
